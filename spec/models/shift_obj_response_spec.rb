...
# Unit tests for Pinwheel::ShiftObjResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Pinwheel::ShiftObjResponse do
  let(:instance) { Pinwheel::ShiftObjResponse.new }

  describe 'test an instance of ShiftObjResponse' do
    it 'should create an instance of ShiftObjResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Pinwheel::ShiftObjResponse)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["shift", "rideshare", "delivery", "other"])
