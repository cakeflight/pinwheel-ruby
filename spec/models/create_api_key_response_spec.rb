...
# Unit tests for Pinwheel::CreateAPIKeyResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Pinwheel::CreateAPIKeyResponse do
  let(:instance) { Pinwheel::CreateAPIKeyResponse.new }

  describe 'test an instance of CreateAPIKeyResponse' do
    it 'should create an instance of CreateAPIKeyResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Pinwheel::CreateAPIKeyResponse)
    end
  end
