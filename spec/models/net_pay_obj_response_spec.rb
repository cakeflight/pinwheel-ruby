...
# Unit tests for Pinwheel::NetPayObjResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Pinwheel::NetPayObjResponse do
  let(:instance) { Pinwheel::NetPayObjResponse.new }

  describe 'test an instance of NetPayObjResponse' do
    it 'should create an instance of NetPayObjResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Pinwheel::NetPayObjResponse)
    end
  end
