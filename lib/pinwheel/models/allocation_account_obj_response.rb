...
module Pinwheel
  class AllocationAccountObjResponse
    # The name of the account, as entered by the user or presented by the platform.
    ...
    # The amount of this allocation, in cents. Required if `allocation_type` is `amount`.
    attr_accessor :amount

    # The name of the bank associated with `allocation.routing_number`, if available.
    attr_accessor :bank_name

    attr_accessor :currency

    # Either the last two or four digits associated with the allocation, dependent on what is displayed by the platform.
    attr_accessor :masked_account_number

    # The percentage of this allocation. Required if `allocation_type` is `percentage`.
    attr_accessor :percentage

    # The priority of this allocation. Lower priority allocations are filled first.
    attr_accessor :priority

    # Either the full routing number or last four digits of the routing number associated with the allocation, dependent on what is displayed by the platform.
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `Pinwheel::AllocationAccountObjResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `Pinwheel::AllocationAccountObjResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      self.allocation_type = if attributes.key?(:allocation_type)
        attributes[:allocation_type]
      end
    ...
    def list_invalid_properties
      ...
      if !@masked_account_number.nil? && @masked_account_number.to_s.length < 2
        invalid_properties.push('invalid value for "masked_account_number", the character length must be great than or equal to 2.')
      end
    ...
    def valid?
      ...
      return false if !@masked_account_number.nil? && @masked_account_number.to_s.length < 2
      true
    end
    ...
    def account_type=(account_type)
      validator = EnumAttributeValidator.new("String", ["checking", "savings", "debit_card", "pay_card"])
    ...
    def allocation_type=(allocation_type)
      validator = EnumAttributeValidator.new("String", ["amount", "percentage", "remainder"])
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        masked_account_number == other.masked_account_number &&
    ...
    def hash
      [account_name, account_type, allocation_type, amount, bank_name, currency, masked_account_number, percentage, priority, routing_number].hash
    end
