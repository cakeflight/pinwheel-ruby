...
module Pinwheel
  class CompanyConnectLinkTokenCreate
    ...
    # Configuration used to specify a Company Connection.
    attr_accessor :company_connect
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `Pinwheel::CompanyConnectLinkTokenCreate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `Pinwheel::CompanyConnectLinkTokenCreate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      self.org_name = if attributes.key?(:org_name)
        attributes[:org_name]
      end

      self.skip_intro_screen = if attributes.key?(:skip_intro_screen)
        attributes[:skip_intro_screen]
      else
        false
      end
      ...
      if attributes.key?(:company_connect)
        self.company_connect = attributes[:company_connect]
      end
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        required_jobs == other.required_jobs &&
        org_name == other.org_name &&
        skip_intro_screen == other.skip_intro_screen &&
        platform_id == other.platform_id &&
        language == other.language &&
        company_connect == other.company_connect
    end
    ...
    def hash
      [required_jobs, org_name, skip_intro_screen, platform_id, language, company_connect].hash
    end
