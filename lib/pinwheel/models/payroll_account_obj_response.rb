...
module Pinwheel
  class PayrollAccountObjResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'data_updated_at')
        self.data_updated_at = attributes[:'data_updated_at']
      else
        self.data_updated_at = nil
      end
