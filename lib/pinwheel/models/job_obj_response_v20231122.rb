...
module Pinwheel
  class JobObjResponseV20231122
    ...
    def initialize(attributes = {})
      ...
      self.timestamp = if attributes.key?(:timestamp)
        attributes[:timestamp]
      end

      self.outcome = if attributes.key?(:outcome)
        attributes[:outcome]
      end
      ...
      self.link_token_id = if attributes.key?(:link_token_id)
        attributes[:link_token_id]
      end
