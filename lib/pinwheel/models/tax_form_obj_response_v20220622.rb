...
module Pinwheel
  class TaxFormObjResponseV20220622
    ...
    # The document for this tax form.
    attr_accessor :document

    # The parsed data of the tax form document.
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `Pinwheel::TaxFormObjResponseV20220622` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `Pinwheel::TaxFormObjResponseV20220622`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      self.form_type = if attributes.key?(:form_type)
    ...
    def form_type=(form_type)
      validator = EnumAttributeValidator.new("String", ["W-2", "W-2C", "1099-NEC", "1099-MISC", "1099-K", "1040"])
    ...
    def hash
      [id, created_at, account_id, form_type, year, document, parsed_data, warnings].hash
    end
