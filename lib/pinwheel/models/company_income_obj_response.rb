...
module Pinwheel
  class CompanyIncomeObjResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Pinwheel::CompanyIncomeObjResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Pinwheel::CompanyIncomeObjResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'employee_external_id')
        self.employee_external_id = attributes[:'employee_external_id']
      else
        self.employee_external_id = nil
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          employee_external_id == o.employee_external_id &&
    ...
    def hash
      [created_at, employee_external_id, compensation_amount, compensation_unit, currency, pay_frequency].hash
    end
