...
module Pinwheel
  class LinkTokenCreateV20231122
    ...
    def initialize(attributes = {})
      ...
      self.disable_direct_deposit_splitting = if attributes.key?(:disable_direct_deposit_splitting)
        attributes[:disable_direct_deposit_splitting]
      else
        false
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        disable_direct_deposit_splitting == other.disable_direct_deposit_splitting &&
        platform_id == other.platform_id &&
        platform_type == other.platform_type &&
        language == other.language &&
        end_user_id == other.end_user_id &&
        account_id == other.account_id &&
        document_uploads == other.document_uploads &&
        tags == other.tags &&
        deposit_forms == other.deposit_forms &&
        end_user == other.end_user
    end
