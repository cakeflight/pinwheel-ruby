...
module Pinwheel
  class EmploymentObjResponse
    ...
    attr_accessor :employer_phone_number
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `Pinwheel::EmploymentObjResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `Pinwheel::EmploymentObjResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:employer_phone_number)
        self.employer_phone_number = attributes[:employer_phone_number]
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        employer_phone_number == other.employer_phone_number &&
        title == other.title
    end
    ...
    def hash
      [id, created_at, updated_at, account_id, status, start_date, termination_date, employer_name, employer_address, employer_phone_number, title].hash
    end
