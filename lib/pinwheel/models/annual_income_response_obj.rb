  ...
  class AnnualIncomeResponseObj
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'gross_pay_ytd')
        ...
        self.gross_pay_ytd = nil
      end

      if attributes.key?(:'net_pay_ytd')
        self.net_pay_ytd = attributes[:'net_pay_ytd']
      else
        self.net_pay_ytd = nil
      end

      if attributes.key?(:'total_deductions_ytd')
        self.total_deductions_ytd = attributes[:'total_deductions_ytd']
      else
        self.total_deductions_ytd = nil
      end

      if attributes.key?(:'total_reimbursements_ytd')
        self.total_reimbursements_ytd = attributes[:'total_reimbursements_ytd']
      else
        self.total_reimbursements_ytd = nil
      end

      if attributes.key?(:'total_taxes_ytd')
        self.total_taxes_ytd = attributes[:'total_taxes_ytd']
      else
        self.total_taxes_ytd = nil
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total_deductions_ytd == o.total_deductions_ytd &&
          total_reimbursements_ytd == o.total_reimbursements_ytd &&
          total_taxes_ytd == o.total_taxes_ytd &&
          earnings_ytds == o.earnings_ytds
    end
