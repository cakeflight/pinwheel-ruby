...
module Pinwheel
  class JobsApi
    ...
    def get_jobs_v1_jobs_get_with_http_info(pinwheel_version, opts = {})
      ...
      allowable_values = ["direct_deposit_switch", "direct_deposit_allocations", "shifts", "paystubs", "employment", "income", "tax_forms", "identity", "direct_deposit_payment"]
      ...
      allowable_values = ["error", "pending", "success"]
