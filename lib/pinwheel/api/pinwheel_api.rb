...
module Pinwheel
  class PinwheelApi
    ...
    def get_earnings_stream_payouts_v1_end_users_end_user_id_earnings_stream_payouts_get_with_http_info(end_user_id, pinwheel_version, opts = {})
      ...
      # resource path
      local_var_path = "/end_users/{end_user_id}/earnings_stream/payouts".sub("{" + "end_user_id" + "}", CGI.escape(end_user_id.to_s).gsub("%2F", "/"))
    ...
    def get_end_user_accounts_v1_end_users_end_user_id_accounts_get_with_http_info(end_user_id, pinwheel_version, opts = {})
      ...
      # resource path
      local_var_path = "/end_users/{end_user_id}/accounts".sub("{" + "end_user_id" + "}", CGI.escape(end_user_id.to_s).gsub("%2F", "/"))
    ...
    def get_end_user_documents_v1_end_users_end_user_id_documents_get_with_http_info(end_user_id, pinwheel_version, opts = {})
      ...
      # resource path
      local_var_path = "/end_users/{end_user_id}/documents".sub("{" + "end_user_id" + "}", CGI.escape(end_user_id.to_s).gsub("%2F", "/"))
    ...
    def get_v1_company_connections_company_connection_id_census_get_with_http_info(company_connection_id, pinwheel_version, opts = {})
      ...
      # resource path
      local_var_path = "/company_connections/{company_connection_id}/census".sub("{" + "company_connection_id" + "}", CGI.escape(company_connection_id.to_s).gsub("%2F", "/"))
    ...
    def get_v1_company_connections_company_connection_id_employments_get_with_http_info(company_connection_id, pinwheel_version, opts = {})
      ...
      # resource path
      local_var_path = "/company_connections/{company_connection_id}/employments".sub("{" + "company_connection_id" + "}", CGI.escape(company_connection_id.to_s).gsub("%2F", "/"))
    ...
    def get_v1_company_connections_company_connection_id_incomes_get_with_http_info(company_connection_id, pinwheel_version, opts = {})
      ...
      # resource path
      local_var_path = "/company_connections/{company_connection_id}/incomes".sub("{" + "company_connection_id" + "}", CGI.escape(company_connection_id.to_s).gsub("%2F", "/"))
    ...
    def get_v1_company_connections_company_connection_id_paystubs_employee_external_id_get_with_http_info(company_connection_id, employee_external_id, pinwheel_version, opts = {})
      ...
      # resource path
      local_var_path = "/company_connections/{company_connection_id}/paystubs/{employee_external_id}".sub("{" + "company_connection_id" + "}", CGI.escape(company_connection_id.to_s).gsub("%2F", "/")).sub("{" + "employee_external_id" + "}", CGI.escape(employee_external_id.to_s).gsub("%2F", "/"))
    ...
    def list_paystubs_v1_accounts_account_id_paystubs_get_with_http_info(account_id, pinwheel_version, opts = {})
      ...
      # resource path
      local_var_path = "/accounts/{account_id}/paystubs".sub("{" + "account_id" + "}", CGI.escape(account_id.to_s).gsub("%2F", "/"))
    ...
    def list_shifts_v1_accounts_account_id_shifts_get_with_http_info(account_id, pinwheel_version, opts = {})
      ...
      # resource path
      local_var_path = "/accounts/{account_id}/shifts".sub("{" + "account_id" + "}", CGI.escape(account_id.to_s).gsub("%2F", "/"))
    ...
    def list_tax_forms_v1_accounts_account_id_tax_forms_get_with_http_info(account_id, pinwheel_version, opts = {})
      ...
      # resource path
      local_var_path = "/accounts/{account_id}/tax_forms".sub("{" + "account_id" + "}", CGI.escape(account_id.to_s).gsub("%2F", "/"))
    ...
    def patch_monitoring_status_v1_sandbox_accounts_account_id_patch_with_http_info(account_id, pinwheel_version, payroll_account_patch_monitoring_status, opts = {})
      ...
      # resource path
      local_var_path = "/sandbox/accounts/{account_id}".sub("{" + "account_id" + "}", CGI.escape(account_id.to_s).gsub("%2F", "/"))
